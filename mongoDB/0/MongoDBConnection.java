...
public class MongoDBConnection {
    ...
    private static final String USERNAME = "elicrisko_db_user";
    private static final String PASSWORD = "acMuvAhJeSXvdEFW";
    private static final String CLUSTER_URL = "cluster0.tv72oas.mongodb.net"; // Substitua pelo seu cluster se for diferente
